...
/* I2C1 */
#define CONF_MII1_CRS		(CONTROL_MODULE + 0x90C) /* SDA */
#define CONF_MII1_RX_ER	(CONTROL_MODULE + 0x910) /* SCL */
#define CONF_I2C1_SDA CONF_MII1_CRS
#define CONF_I2C1_SCL CONF_MII1_RX_ER
/* I2C2 */
#define CONF_SPI0_D1		(CONTROL_MODULE + 0x958)
#define CONF_SPI0_D0		(CONTROL_MODULE + 0x954)
#define CONF_I2C2_SDA CONF_SPI0_D1
#define CONF_I2C2_SCL CONF_SPI0_D0
/* MMC0 */
